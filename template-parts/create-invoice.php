                    ...
                    <form method="post" id="invoiceValid" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                        ...
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-3">
                            ...
                            <input type="text" name="fin_yr" id="basic-default-date" class="form-control" value="<?php echo $invoice_details['invoice_fin_yr']; ?>" />
                          </div>   
                          <div class="mb-3 col-md-6">
                            <label class="form-label" for="basic-default-fullname">Full Name</label>
                            <input type="text" name="client_name" class="form-control" id="basic-default-fullname" placeholder="Client Name" value="<?php echo $invoice_details['client_name']; ?>" />
                          </div>                                            
                        </div>
                    ...
                    foreach ($invoice_items as $key => $invoice_item) { ?>
                      <div class='element' id='div_<?php echo $invoice_item['ID'];?>'>
                          <div class="row">
                            ...
                            <div class="mb-3 col">
                              <input type='text' name="item[<?php echo $key;?>][item_quantity]" id= "txt_1" class="form-control" placeholder="Quantity" value="<?php echo $invoice_item['item_quantity'];?>"/>
                            </div>
                            <div class="mb-3 col">
                              <input type='text' name="item[<?php echo $key;?>][item_rate]" class="form-control" placeholder="Rate" value="<?php echo $invoice_item['item_rate'];?>"/>
                            </div>
                          <div class="mb-3 col">
                      ...
                      <form method="post" id="invoiceValid" action="<?php echo $_SERVER['REQUEST_URI'];?>">
                        ...
                        <div class="row">                                                  
                          <div class="mb-3 col-md-3">
                            ...
                            <input type="tel" name="client_phone" id="default-phone" class="form-control phone-mask" placeholder="658 799 8941"  />
                          </div>
                          <div class="mb-3 col-md-3">
                            <label class="form-label" for="client-type">Type of Client</label>
