            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post">
                ...
                <div class="mb-3">
                  ...
                  <label for="log-user" class="form-label">Email or Username</label>
                  <input type="text" id="log-user" class="form-control" name="user_name" placeholder="Enter user name" autofocus />
